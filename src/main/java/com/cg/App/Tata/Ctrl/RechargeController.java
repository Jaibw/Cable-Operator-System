...
public class RechargeController {
	...
	public Recharge createRecharge(@RequestBody Pack pack, @RequestBody Account account) {
	...
	public List<Recharge> findAllRechargesInPeriod(@PathVariable LocalDate startDate, @PathVariable LocalDate endDate) {
		return rcgservice.findAllRechargesInPeriod(startDate, endDate);
	}

	@GetMapping("/countRecharges/{startDate}/{endDate}")
	public int countRechargesInPeriod(@PathVariable LocalDate startDate,@PathVariable LocalDate endDate) {
		return rcgservice.countRechargesInPeriod(startDate, endDate);
	}

	@GetMapping("/totalrevenueinPeriod/{startDate}/{endDate}")
	public double totalRevenueInPeriod(@PathVariable LocalDate startDate, @PathVariable LocalDate endDate) {
	...
	public String expireIfValidityFinished(@RequestBody Account account, @RequestBody Recharge recharge) {
